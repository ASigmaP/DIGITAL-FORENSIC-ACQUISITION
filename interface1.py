...
class mainWindow_1(QMainWindow):
    ...
    def interface(self):
        ...
        #pengaturan window Application
        self.setWindowTitle('DIGITAL FORENSIC ACQUISITION ')
        #self.resize(770, 520)
        self.resize(500, 250)
        # self.setStyleSheet("QMainWindow {background:rgb(0, 0, 128)}")
        # self.setWindowIcon(QtGui.QIcon("/home/debian/Documents/Forensic-Imaging-Application-master/imgakuisisi.png"))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/home/debian/Documents/DIGITAL FORENSIC ACQUISITION/imgakuisisi.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.display.horizontalHeader().setStyleSheet("QHeaderView::section{Background-color:rgb(178, 34, 33);font:bold}")
        ...
        iconNext.addPixmap(QtGui.QPixmap("/home/debian/Documents/DIGITAL FORENSIC ACQUISITION/next"),
                           QtGui.QIcon.Normal)
    ...
    def menuAbout(self):
        self.tulisan = QLabel('Anfika Sigma P.', self)
